...
\documentclass[48pt, nnermargin=7mm, blockverticalspace=7mm, colspace=7mm]{tikzposter}\usepackage[]{graphicx}\usepackage[]{color}
...
\includegraphics[width=.25\columnwidth]{figures/latex-abundance-per-class} 
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=.27\columnwidth]{figures/latex-top-species} 
